...
**זיהוי סוג הנושא:**
לפני שאתה כותב, זהה לאיזה סוג שייך הנושא:
- סוג א' — נושא היסטורי: מלחמה, אירוע, מנהיג, תקופה, מהפכה
- סוג ב' — מקום / אתר: עיר, אתר, נהר, כיכר, מבנה, אזור גיאוגרפי
- סוג ג' — תופעה / המצאה / תחום: ספורט, אמנות, טכנולוגיה, דת, תנועה חברתית, המצאה

בחר את ערכת הפרקים המתאימה לסוג:
...
[SECTION][HEADING]כותרת מותאמת: לאירוע — "מי עשה את זה?", לביוגרפיה — "מי היה באמת?", לתקופה — "מי עיצב את התקופה?", למלחמה — "המנהיגים משני הצדדים"[/HEADING][CONTENT]שמות ספציפיים של האנשים המרכזיים[/CONTENT][/SECTION]
...
- לסוג ב': מהתיעוד הראשון של המקום עד היום
- לסוג ג': מהרגע הראשון של ההמצאה/תופעה עד מצבה כיום
כל תיאור — עד 7 מילים.
[TIMELINE]
